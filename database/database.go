...
const (
	...
	InsertStatement   = "INSERT INTO ratesinfotable (pairname, exchangename, rate, time) VALUES ($1, $2, $3, $4) WHERE NOT EXISTS (SELECT * FROM ratesinfotable WHERE pairname = $1)"
